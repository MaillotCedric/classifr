...
function ajouter_ajax_call(evenement, element_id, methode, ajax_url, donnees={}, success_callback=afficher_success, error_callback=afficher_error) {
    $(document).on(evenement, "#"+element_id, function(event){
